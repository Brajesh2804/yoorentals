...
<script>
    ...
    // Timer logic: Page load hote hi 3 seconds baad messages gayab ho jayenge
                ...
                <div
                    ...
                    <div class="relative mt-4">
                        <div class="w-28 h-28 bg-white p-1.5 rounded-full mx-auto shadow-lg">
                            <div class="w-full h-full bg-slate-100 rounded-full flex items-center justify-center text-3xl font-black text-blue-600 overflow-hidden">
                                <?php if (!empty($user->image)): ?>
                                    <img src="<?= base_url('uploads/profile/' . $user->image) ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                ...
                <div class="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 p-8 md:p-10">
                    ...
                    <form action="<?= base_url('users/updateProfile') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center gap-2 mb-8">
                            ...
                            <h3 class="text-lg font-black text-slate-800 tracking-tight uppercase">General Information</h3>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Phone Number</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Profile Image</label>
                                <input type="file" name="image" readonly
                                    class="profile-input w-full px-4 py-3 bg-slate-100 border border-slate-200 rounded-2xl outline-none transition-all font-semibold text-slate-700 cursor-not-allowed">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">New Password</label>
